...
from modulos.users.auth_controller import auth_router
from modulos.users.users_controller import users_router
...
app = FastAPI(title="Facturas-Manizales", version="0.0.1")
